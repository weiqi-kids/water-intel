...
class MuellerFetcher(CompanyFetcher):
    """Mueller Water Products 爬蟲"""

    company_id = "mueller"
    company_name = "Mueller Water Products"
    news_url = "https://www.muellerwaterproducts.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.muellerwaterproducts.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Mueller Water Products")
        return documents

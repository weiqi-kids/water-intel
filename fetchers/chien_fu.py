...
class ChienFuFetcher(CompanyFetcher):
    """千附精密 爬蟲"""

    company_id = "chien_fu"
    company_name = "千附精密"
    news_url = "https://www.千附精密.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 千附精密")
        return documents

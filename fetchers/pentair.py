...
class PentairFetcher(CompanyFetcher):
    """Pentair 爬蟲"""

    company_id = "pentair"
    company_name = "Pentair"
    news_url = "https://www.pentair.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Pentair")
        return documents

...
class KuritaFetcher(CompanyFetcher):
    """Kurita Water Industries 爬蟲"""

    company_id = "kurita"
    company_name = "Kurita Water Industries"
    news_url = "https://www.kuritawaterindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.kuritawaterindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Kurita Water Industries")
        return documents

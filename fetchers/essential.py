...
class EssentialFetcher(CompanyFetcher):
    """Essential Utilities 爬蟲"""

    company_id = "essential"
    company_name = "Essential Utilities"
    news_url = "https://www.essentialutilities.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.essentialutilities.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Essential Utilities")
        return documents

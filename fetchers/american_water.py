...
class AmericanWaterFetcher(CompanyFetcher):
    """American Water Works 爬蟲"""

    company_id = "american_water"
    company_name = "American Water Works"
    news_url = "https://www.americanwaterworks.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.americanwaterworks.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from American Water Works")
        return documents

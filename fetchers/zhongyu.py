...
class ZhongyuFetcher(CompanyFetcher):
    """中宇環保 爬蟲"""

    company_id = "zhongyu"
    company_name = "中宇環保"
    news_url = "https://www.中宇環保.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 中宇環保")
        return documents

...
class BadgerFetcher(CompanyFetcher):
    """Badger Meter 爬蟲"""

    company_id = "badger"
    company_name = "Badger Meter"
    news_url = "https://www.badgermeter.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.badgermeter.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Badger Meter")
        return documents

...
class XylemFetcher(CompanyFetcher):
    """Xylem 爬蟲"""

    company_id = "xylem"
    company_name = "Xylem"
    news_url = "https://www.xylem.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Xylem")
        return documents

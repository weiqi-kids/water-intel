...
class WattsFetcher(CompanyFetcher):
    """Watts Water Technologies 爬蟲"""

    company_id = "watts"
    company_name = "Watts Water Technologies"
    news_url = "https://www.wattswatertechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.wattswatertechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Watts Water Technologies")
        return documents

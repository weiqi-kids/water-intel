...
class VeoliaFetcher(CompanyFetcher):
    """Veolia Environnement 爬蟲"""

    company_id = "veolia"
    company_name = "Veolia Environnement"
    news_url = "https://www.veoliaenvironnement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.veoliaenvironnement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Veolia Environnement")
        return documents

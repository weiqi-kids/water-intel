...
class AoSmithFetcher(CompanyFetcher):
    """A.O. Smith 爬蟲"""

    company_id = "ao_smith"
    company_name = "A.O. Smith"
    news_url = "https://www.aosmith.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from A.O. Smith")
        return documents

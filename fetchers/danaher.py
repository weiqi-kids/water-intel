...
class DanaherFetcher(CompanyFetcher):
    """Danaher 爬蟲"""

    company_id = "danaher"
    company_name = "Danaher"
    news_url = "https://www.danaher.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Danaher")
        return documents
